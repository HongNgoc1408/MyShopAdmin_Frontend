...
const Users = () => {
  ...
  return (
    <>
      <Modal
        title={
          editingUser ? "Cập nhật thông tin khách hàng" : "Thêm khách hàng"
        }
        open={open}
      ...
      >
        <Form
          ...
          initialValues={{
            ...editingUser,
            email: editingUser ? editingUser.email : "@gmail.com",
            password: "",
            roles: editingUser ? editingUser.roles : ["User"],
          }}
          autoComplete="off"
        >
          <Form.Item
          ...
          >
            {/* <Select
              mode="multiple"
              options={[{ label: "Khách hàng", value: "User" }]}
            /> */}
          </Form.Item>
        </Form>
      </Modal>
